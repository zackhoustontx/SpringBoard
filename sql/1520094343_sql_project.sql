...
SELECT Distinct name, CONCAT(Members.firstname, ' ', Members.surname) AS member_name 
FROM Bookings
JOIN Members
...
SELECT Facilities.name,   
	SUM((Bookings.memid = 0)*slots*guestcost + (Bookings.memid != 0)*slots*membercost) AS revenue
    /*, SUM(CASE WHEN Bookings.memid != 0 THEN (slots*membercost)
